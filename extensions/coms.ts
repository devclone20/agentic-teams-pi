...
export default function (pi: ExtensionAPI) {
	...
	// Guards use try/catch so loading coms.ts alongside coms-net.ts is safe —
	// both share these flag names and the second registration would otherwise
	// throw "Flag already registered".
	try { pi.registerFlag("cname", {
		...
		type: "string",
		default: undefined,
	}); } catch { /* already registered by coms-net */ }
